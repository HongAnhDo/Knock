...
public class IndicatorView extends View implements IndicatorInterface, ViewPager.OnPageChangeListener {
    ...
    private static final int DEFAULT_RADIUS_UNSELECTED = 10;
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        this.colorSelected = typedArray.getColor(R.styleable.IndicatorView_hado_color_selected, Color.parseColor("#FF4081"));

        this.colorUnselected = typedArray.getColor(R.styleable.IndicatorView_hado_color_unselected, Color.parseColor("#bcbcbc"));
